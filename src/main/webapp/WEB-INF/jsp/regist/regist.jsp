    ...
    <div class="span24">
        <div class="wrap">
            <div class="main clearfix">
                ...
                <form id="registerForm" action="${ pageContext.request.contextPath }/preuserAction_regist.action"
                      method="post"
                    ...
                    <div class="login">
                        ...
                        <dl>
                            ...
                            <dd>
                                立即登录即可体验在线购物！
                                <a href="${pageContext.request.contextPath}/preuserAction_loginPage.action">立即登录</a>
                            </dd>
                        </dl>
                    </div>
                </form>

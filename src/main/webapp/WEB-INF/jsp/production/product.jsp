...
<div class="container productContent">
    ...
    <div class="span18 last">
        ...
        <div class="name"><s:property value="production.pname"/></div>
        <div class="sn">
            <div>编号：<s:property value="production.pid"/></div>
        </div>
        <div class="info">
            <dl>
                <dt>商城价:</dt>
        ...
        <form id="cartForm" action="${ pageContext.request.contextPath }/cartAction_addCart.action" method="post">
            <input type="hidden" name="pid" value="<s:property value="production.pid"/>"/>
        ...
        <div id="introduction" name="introduction" class="introduction">
            <div class="title">
                <strong><s:property value="production.pdesc"/></strong>
            </div>
            <div>
                <img src="${pageContext.request.contextPath }/<s:property value="production.image"/>">
            </div>
        </div>
